...
function init() {
  ...
  loginRegister.addEventListener('click', () => {
    ...
    registerBtn.addEventListener('click', () => {
      const email = document.querySelector('#register__mail').value;
      const password = document.querySelector('#register__pass').value;
  ...
  const loginBtn = document.querySelector('#login__accept');
  loginBtn.addEventListener('click', () => {
    const userEmail = document.querySelector('#login__email').value;
    const userPass = document.querySelector('#login__pass').value;
